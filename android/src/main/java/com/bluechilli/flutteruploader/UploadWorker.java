...
public class UploadWorker extends Worker implements CountProgressListener {
    ...
    public static final String ARG_IS_API_REQUEST = "isApiRequest";
    public static final String ARG_JWT = "jwtToken";
    ...
    public Result doWork() {
        ...
        isAPICall = getInputData().getBoolean(ARG_IS_API_REQUEST, false);
        jwtToken = getInputData().getString(ARG_JWT);
